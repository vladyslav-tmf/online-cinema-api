...
@router.get(
    ...
    responses={
        200: {
            "description": (
                "Successfully retrieved the user's cart or created a new one."
            ),
        },
        404: {
...
@router.post(
    ...
    description=(
        ...
        "If the item already exists in the cart, an error is returned."
    ),
    responses={
        201: {
...
@router.delete(
    ...
    responses={
        204: {"description": "Item successfully removed from the cart."},
        404: {
...
@router.delete(
    ...
    responses={
        204: {"description": "All items successfully removed from the cart."},
        404: {
